...
#                             read hmmrfiles                             #
#-----------------------------------------------------------------------#
hmmrHit <- as.matrix(read.table("../Documents/sort.hit.S.areus.csv",header=F,sep=" ",stringsAsFactors = F))
length.hmmrHit= nrow(hmmrHit)
intersections<- list.files("../Documents/intersection/")
...
#                                                                                    #
#------------------------------------------------------------------------------------#
inputs<- list.files("/intersection/")
