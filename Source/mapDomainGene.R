...
write.table(unique(genelist[,1]),"~/Dropbox/INDEPENDENT sTYDY 2/data/genelist.txt", row.names = FALSE, quote = FALSE, col.names = FALSE)
#---------------------------------------------------------------------
list.of.significant.genes<-unique(genelist[,1])
